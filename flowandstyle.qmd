...
-   We adopt a code style that generally matches [tidyverse](https://style.tidyverse.org/index.html) (offer kdv lintr as a resource), with some exceptions:
...
-   508 compliance is always recommend to clients and we always do as much as feasible within the scope of our budget. This is to ensure that all of our software products are accessible to users with disabilities.

-   There are a handful of online tools that can review documents for 508 compliance, such as the [Accessibility Tests for Electronic Documents](https://www.section508.gov/test/documents/), (provide more online tools that can review code preferably without storing it - there are some, I think)
